		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		  		...
		  		<div class="form-group">
		  		    ...
		  		    <input type="text" id="nombre_formal"  name="nombre_formal"  maxlength="50" class="form-control input-md" placeholder="Nombre Formal" data-validacion-tipo="alfa|requerido|min:5" value="<?php  echo $data['usuario']->nombre_formal; ?>" readonly />
	...
	$(document).ready(function(){      //Add this line (and it's closing line)
        ...
        function enviarSolicitud(formData){
    		$.ajax({
    		    ...
    		    url: GLOBAL_PATH+"ofcpartes/guardarEditarContrasenaPersonal",
    		    type: 'POST',
    		    data: formData,
    		    beforeSend: function(){
