		...
		<div class="row">
			...
			<div class="col-md-6">
			    ...
			    <div class="form-group">
			      ...
			      <textarea class="form-control input-sm"  name="asunto_oficio" readonly placeholder="Asunto del Oficio" style="height: 108px;"><?php echo $data['oficio']->asunto_emisor ?></textarea>
			    </div>
