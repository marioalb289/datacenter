		...
		<div class="panel-heading">
			<div class="row">
				...
				<div class="col-md-6 text-right">
					<?php if( ($_SESSION['data_user']['privilegios'] == 3 || $_SESSION['data_user']['privilegios'] == 2) && $data['oficio']->tipo_oficio == "SOLICITUD" && $data['oficio']->id_usuario_emisor == $_SESSION['data_user']['id'] && $data['oficio']->ccp == 0 && $data['oficio']->estatus_final == 'Cerrado' && $data['total_revision'] == 0){ ?>
			...
			<div class="row">
				<div class="col-md-6 ">
					...
					<div id="formInterno" >
						...
						<div class="form-group">
						   <label for="recepciones_nombreEmisor" class="required">Usuario Origen:</label>
						    <input type="text" id="usuario_receptor" readonly="" class="form-control input-md" value="<?php echo ucwords(mb_strtolower($data['usuario_emisor']->nombre_formal,'UTF-8')) ; ?>" />
						    <span class="text-danger"></span>
						</div>
					...
					<div id="formExterno">
						...
						<div class="form-group">
					        ...
					        <div class="row">
			        	        <div class="col-md-6">
			        	        	<input type="date" id="fecha_recepcion" readonly name="fecha_recepcion"  class="form-control input-md" placeholder="Fecha de Recepción" value="<?php echo $data['oficio']->fecha_recepcion ; ?>"/>
			        	        </div>
			        	        <div class="col-md-6">
			        		        <input type="time" id="hora_recepcion" readonly name="hora_recepcion"  class="form-control input-md" placeholder="Fecha de Recepción" value="<?php echo $data['oficio']->hora_recepcion; ?>"/>
			        	        </div>
					        </div>
					...
					<div class="form-group">
					   <label for="recepciones_nombreEmisor" class="required">Usuario Destino:</label>
					    <input type="text" id="usuario_receptor" readonly="" class="form-control input-md" value="<?php if(empty($data['usuario_receptor'])) {echo "";} else {echo ucwords(mb_strtolower($data['usuario_receptor']->nombre_formal,'UTF-8'));} ?>" />
					    <span class="text-danger"></span>
					</div>
					<?php } ?>
				...
				<div class="col-md-6">
				    ...
				    <div class="form-group">
				      ...
				      <textarea class="form-control input-md"  name="asunto_oficio" readonly placeholder="Asunto del Oficio" style="height: 100px;"><?php echo $data['oficio']->asunto_emisor ?></textarea>
				    </div>

				    <div class="form-group">
				      <label for="exampleInputFile">Comentarios:</label>			      
				      <!-- <input type="file" name="archivo" id="documento_iepc" required="required"> -->
				      <textarea class="form-control input-md"  name="comentarios" readonly placeholder="Asunto del Oficio" style="height: 100px;"><?php echo $data['oficio']->comentarios ?></textarea>
				    </div>
