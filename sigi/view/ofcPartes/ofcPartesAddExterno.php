				...
				<div class="row">
					<div class="col-md-6">
			            ...
			            <div id="formExterno">
						    ...
						    <div class="form-group ">
						        ...
						        <input type="text" id="institucion_emisor" name="institucion_emisor"  maxlength="50" class="form-control input-md" placeholder="Institucion del Titular" data-validacion-tipo="alfa|requerido|min:5" />
						        <span class="text-danger"></span>
					...
					<div class="col-md-6">					
					    ...
					    <div class="form-group">
					      ...
					      <textarea class="form-control input-md"  name="asunto_oficio" id="asunto_oficio" maxlength="150" placeholder="Asunto del Oficio" style="height: 100px;" data-validacion-tipo="alfa-numerico|requerido|min:10"></textarea>
					    </div>
