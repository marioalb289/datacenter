<div>
	...
	<h1 class="page-header">Responder Oficio ya Vinculado</h1>
				...
				<div class="row">
					<div class="col-md-6 ">
						<div class="form-group">
							...
							<input type="hidden" name="ofc_vinculado" value = "1">
						</div>
		...
		$("form").submit(function( event ) {
			...
			if(res){
			    ...
			    if(enviar){
			    	bootbox.confirm({
			    	    title: "Advertencia",
			    	    message: "El mensaje será marcado como ya vinculado. Los cambios no se pondrán deshacer.<br> ¿Desea continuar?",
			    	    buttons: {              
			    	        cancel: {
			    	            label: 'No',
